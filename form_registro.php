...
<title>:Conceptual_registro:</title>
...
<nav class="navbar navbar-light bg-light fixed-top">
    ...
    <div class="col-lg-6 mx-auto">
        <p></p>
	<h2 class="text-center"  style="padding-top: 20px; padding-bottom:20px;">Registrate</h2>
    <form action="registro.php" method="post" >
    	<label>
        	<input class="form-control mx-auto" placeholder="nombre" type="text" name="nombre" required />
        </label><br />
        <p></p>
		<label>
        	<input class="form-control mx-auto" placeholder="apellido" type="text" name="apellido" required />
        </label><br />
        <p></p>
        <label>
        	<input class="form-control mx-auto" placeholder="email" type="email" name="email" required />
        </label><br />
        <p></p>
        <label>
        	<input class="form-control mx-auto" placeholder="usuario" name="usuario" type="text" maxlength="12" />
        </label><br />
        <p></p>
        <label>
        	<input class="form-control mx-auto" placeholder="password" type="password" name="password" maxlength="12" />
        </label><br />
        <p></p>
